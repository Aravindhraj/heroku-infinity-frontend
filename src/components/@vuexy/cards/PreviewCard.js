      ...
      <CardBody className='invoice-padding pb-0'>
        ...
        <div className='d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0'>
          <div>
            ...
            <CardText className='mb-25'>TCTJ Building, 73M, Thadikombu Road</CardText>
            <CardText className='mb-25'>Dindugul - 624 001</CardText>
            <CardText className='mb-0'>+91 7397790001, +91 7397790001</CardText>
          </div>
          <div className='mt-md-0 mt-2'>
            <h4 className='invoice-title'>
              {/* Receipt <span className='invoice-number'>#{data.invoice.id}</span> */}
              Receipt <span className='invoice-number'>#8596</span>
            </h4>
            <div className='invoice-date-wrapper'>
              <p className='invoice-date-title'>Date Issued:</p>
              <p className='invoice-date'>23 Jan 2021</p>
            ...
            <div className='invoice-date-wrapper'>
              ...
              <p className='invoice-date'>15 Feb 2021</p>
            </div>
          </div>
        </div>
        {/* /Header */}
      ...
      <CardBody className='invoice-padding pt-0'>
        <Row className='invoice-spacing'>
          <Col className='p-0' lg='8'>
            ...
            <h6 className='mb-25'>Aravindhan Rengaraj</h6>
            <CardText className='mb-25'>Verizon</CardText>
            <CardText className='mb-25'>4/122, 16th cross Shanmuga Nagar</CardText>
            <CardText className='mb-25'>7799532978</CardText>
            <CardText className='mb-0'>aravindh.rengaraj@gmail.com</CardText>
          </Col>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    ...
                    <span className='font-weight-bolder'>95000 INR</span>
                  </td>
                </tr>
                <tr>
